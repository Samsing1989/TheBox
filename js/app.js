(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-page__slider")) new swiper_core_Swiper(".main-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".main-page__button-left.swiper-button-prev",
                nextEl: ".main-page__button-right.swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".body-tab__slider")) new swiper_core_Swiper(".body-tab__slider", {
            ...
            navigation: {
                prevEl: ".projects__button-left.swiper-button-prev",
                nextEl: ".projects__button-right.swiper-button-next"
            },
            breakpoints: {
                640: {
                    slidesPerView: 1,
